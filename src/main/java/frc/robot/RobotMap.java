...
public class RobotMap {
	...
	public static final int ELEVATOR_SPARK = 4;
	public static final int ELEVATOR_SPARK2 = 5;
	
	public static final int INTAKE_TALON = 6;

	// Joystick
	public static final int OI_DRIVER_CONTROLLER_MOVER = 0;
	public static final int OI_DRIVER_CONTROLLER_OPERATOR = 1;
	...
	public static final int ENCODER_ELEVATOR = 2;
